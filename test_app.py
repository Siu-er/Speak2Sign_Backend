...
# Default Whisper model - change this to test different models
...
def audio_to_text():
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(delete=False, suffix='.wav') as tmp_file:
            ...
            with torch.no_grad():
                predicted_ids = whisper_model.generate(**inputs, language="en")
...
def audio_to_text_base64():
    ...
    try:
        ...
        # debug_path = f"debug_audio_{timestamp}.wav"
        # sf.write(debug_path, audio, sample_rate)
